...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-relay/node_modules/react-relay/lib/RelayQueryTransform.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-relay/node_modules/react-relay/lib/RelayQueryTransform.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-relay/node_modules/react-relay/lib/</a> &#187; RelayQueryTransform.js</div>
</div>
<div class="body">
...
&nbsp;
  RelayQueryTransform.prototype.traverse = <span class="fstat-no" title="function not covered" >function traverse(node, nextState) {</span>
...
<span class="cstat-no" title="statement not covered" >    var nextChildren = void 0;</span>
<span class="cstat-no" title="statement not covered" >    this.traverseChildren(node, nextState, <span class="fstat-no" title="function not covered" >function (child, index, children) {</span></span>
<span class="cstat-no" title="statement not covered" >      var prevChild = children[index];</span>
<span class="cstat-no" title="statement not covered" >      var nextChild = this.visit(prevChild, nextState);</span>
<span class="cstat-no" title="statement not covered" >      if (nextChild !== prevChild) {</span>
<span class="cstat-no" title="statement not covered" >        nextChildren = nextChildren || children.slice(0, index);</span>
      }
<span class="cstat-no" title="statement not covered" >      if (nextChildren &amp;&amp; nextChild) {</span>
<span class="cstat-no" title="statement not covered" >        nextChildren.push(nextChild);</span>
      }
    }, this);
<span class="cstat-no" title="statement not covered" >    if (nextChildren) {</span>
<span class="cstat-no" title="statement not covered" >      if (!nextChildren.length) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
<span class="cstat-no" title="statement not covered" >      return node.clone(nextChildren);</span>
    }
<span class="cstat-no" title="statement not covered" >    return node;</span>
  };
&nbsp;
