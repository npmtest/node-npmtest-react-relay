...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-relay/node_modules/react-relay/lib/RelayRootContainer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-relay/node_modules/react-relay/lib/RelayRootContainer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-relay/node_modules/react-relay/lib/</a> &#187; RelayRootContainer.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function RelayRootContainer(_ref) {</span>
<span class="cstat-no" title="statement not covered" >  var Component = _ref.Component,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return require('react').createElement(require('./RelayRenderer'), {</span>
    Container: Component,
    ...
    render: <span class="fstat-no" title="function not covered" >function render(_ref2) {</span>
<span class="cstat-no" title="statement not covered" >      var done = _ref2.done,</span>
          error = _ref2.error,
          props = _ref2.props,
          retry = _ref2.retry,
          stale = _ref2.stale;
...
<span class="cstat-no" title="statement not covered" >        if (renderFailure) {</span>
<span class="cstat-no" title="statement not covered" >          return renderFailure(error, retry);</span>
        }
      } else <span class="cstat-no" title="statement not covered" >if (props) {</span>
<span class="cstat-no" title="statement not covered" >        if (renderFetched) {</span>
<span class="cstat-no" title="statement not covered" >          return renderFetched(props, { done: done, stale: stale });</span>
        } else {
<span class="cstat-no" title="statement not covered" >          return require('react').createElement(Component, props);</span>
        }
      } else {
<span class="cstat-no" title="statement not covered" >        if (renderLoading) {</span>
<span class="cstat-no" title="statement not covered" >          return renderLoading();</span>
        }
      }
